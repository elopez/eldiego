...
\addtolength{\voffset}{-1.3in}     % ~ -0.5 del incremento anterior
...
\newpagestyle{main}[\small]{
  \setheadrule{.4pt}%
  \sethead{\normalfont\textbf{\title}}%
          {\normalfont\MakeUppercase{\sectiontitle}\ -\ \subsectiontitle}%
          {\normalfont{Página \thepage\ de \pageref{LastPage}}}%
}
\pagestyle{main}
